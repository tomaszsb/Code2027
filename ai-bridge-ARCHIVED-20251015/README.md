# ⚠️ DEPRECATED - AI Bridge Communication System

> **🚫 DO NOT USE THIS SYSTEM FOR NEW DEVELOPMENT**
>
> **Status:** DEPRECATED - Legacy Backup Only
...
**Primary Communication Channel:** **claude-ipc-mcp (IPC System)**

### Why Use IPC Instead?
- ✅ Real-time messaging (no polling delays)
- ✅ Simple MCP tool interface
- ✅ Industry-standard protocol
- ✅ Works across all AI environments
- ✅ No file management needed

### How to Use IPC
See the main project charters:
- **~/.gemini/GEMINI.md** - Gemini's IPC guide
- **code2027/CLAUDE.md** - Claude's IPC guide
- **code2027/claude-ipc-mcp/README.md** - Full IPC documentation
...
**DO NOT implement new features using this system.**
