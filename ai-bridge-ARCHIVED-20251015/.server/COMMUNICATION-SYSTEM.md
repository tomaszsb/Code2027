# ⚠️ DEPRECATED - AI-to-AI Communication System

> **🚫 DO NOT USE - THIS IS LEGACY DOCUMENTATION**
>
> **Status:** DEPRECATED - Use claude-ipc-mcp Instead
> **Version:** 9.0 (Frozen - No Updates)
> **Date:** October 7, 2025

---

## ❌ THIS FILE-BASED SYSTEM IS DEPRECATED

**Use the IPC System Instead:** `claude-ipc-mcp`

### Why You're Seeing This File

If you're reading this, you likely:
1. ❌ Found this via search (use IPC documentation instead)
2. ❌ Following old instructions (see ~/.gemini/GEMINI.md or CLAUDE.md)
3. ❌ Debugging communication issues (check IPC first: `mcp__claude-ipc__check`)

### Switch to IPC Now

**For Gemini:**
- Register: `mcp__claude-ipc__register(instance_id="gemini-cli")`
- Check: `mcp__claude-ipc__check(instance_id="gemini-cli")`
- Send: `mcp__claude-ipc__send(from_id="gemini-cli", to_id="claude", content="...")`

**For Claude:**
- Register: `mcp__claude-ipc__register(instance_id="claude")`
- Check: `mcp__claude-ipc__check(instance_id="claude")`
- Send: `mcp__claude-ipc__send(from_id="claude", to_id="gemini-cli", content="...")`

---

## 🔒 Legacy File-Based System Documentation

**Preserved for emergency backup only. DO NOT USE.**

The OLD communication system used:
