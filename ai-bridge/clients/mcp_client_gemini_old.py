...
# Directories
INBOX_DIR = SERVER_DIR / "claude-outbox"  # Your inbox (Claude's outbox)
OUTBOX_DIR = SERVER_DIR / "gemini-outbox"  # Your outbox
...
def validate_message(message: Dict[str, Any]) -> bool:
    ...
    try:
        ...
        print(f"Validation error (both schemas failed): {e}")
        return False
